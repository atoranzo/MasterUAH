<template>
    <div>
        ...
        <div class="row">
            <div class="col-md-3">
                <h3>Actualizando su Perfil</h3><hr>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Actualice su estado laboral" type="text" v-model="userStatus">
                </div>

               <div class="form-group">
                    <label for="description">Education</label>
                    <input class="form-control" placeholder="actualice su educación" type="text" v-model="userEducation">
                </div>

              <div class="form-group">
                    <label for="description">Phone</label>
                    <input class="form-control" placeholder="Actualize su teléfono" type="text" v-model="userPhone">
                </div> 

             <div class="form-group">
                    <label for="description">Competences</label>
                    <input class="form-control" placeholder="Actualice sus competencias" type="text" v-model="userCompetences">
                </div>

             <div class="form-group">
                    <label for="description">Projects</label>
                    <input class="form-control" placeholder="Actualice sus proyectos" type="text" v-model="userProjects">
                </div>                        

                <button class="btn btn-primary" :disabled="disableSubmit" @click="performSubmit">Grabar</button>
                <strong v-show="submitting">Enviando...</strong>
                <strong v-show="errorSubmit" class="text-danger">¡Ocurrió un error!</strong>
                <strong v-show="successSave" class="text-success">¡Transacción remitida!</strong>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             *      userDet[3] => string   user's education
             *      userDet[4] => string   user's phone
             *      userDet[5] => string   user's competences
             *      userDet[6] => string   user's projects
             */
            getProfile() {
                window.bc.contract().getOwnProfile((error, userDet) => {
                    ...
                    this.userEducation = userDet[3]
                    this.userPhone = userDet[4]
                    this.userCompetences = userDet[5]
                    this.userProjects = userDet[6]
                })
            },
